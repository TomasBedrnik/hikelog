    ...
    <main className="min-h-screen bg-[linear-gradient(180deg,#f5f1e8_0%,#f8fafc_30%,#ffffff_100%)] p-6 text-stone-900">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-8 rounded-[32px] border border-stone-300/80 bg-white p-6 shadow-sm">
          ...
          {!content && !error ? <p className="mt-4 text-sm text-stone-600">{dict.common.loading}</p> : null}
          ...
          <section className="mt-6 rounded-[28px] border border-stone-200 bg-stone-50 p-5">
            ...
            <div className="mt-5 grid gap-5">
              <label className="block">
                <span className="text-sm font-medium text-stone-700">{dict.globalContent.mainHeadline}</span>
                <input
              ...
              <div>
                <p className="mb-2 text-sm font-medium text-stone-700">{dict.globalContent.homeText}</p>
                <TripContentEditor
          ...
          <section className="mt-6 rounded-[28px] border border-stone-200 bg-stone-50 p-5">
            <h2 className="text-lg font-semibold text-stone-900">{dict.globalContent.imageSection}</h2>
            ...
            <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
              <label className="block">
                <span className="text-sm font-medium text-stone-700">{dict.globalContent.imageFile}</span>
                <input
                  key={inputKey}
              ...
              <div className="space-y-4 rounded-[1.5rem] border border-stone-200 bg-white p-4">
                <div>
                  <p className="text-sm font-medium text-stone-700">{dict.globalContent.resizeMode}</p>
                ...
                {resizeMode === "resize" ? (
                  <div className="grid gap-4 sm:grid-cols-2">
                    <label className="block">
                      <span className="text-sm font-medium text-stone-700">{dict.globalContent.width}</span>
                      <input
                    ...
                    <label className="block">
                      <span className="text-sm font-medium text-stone-700">{dict.globalContent.height}</span>
                      <input
                        className="mt-2 w-full rounded-2xl border border-stone-300 px-4 py-3 outline-none transition focus:border-emerald-600"
                        inputMode="numeric"
                        onChange={(event) => {
            ...
            {content?.hero_image_url ? (
              ...
              <p className="mt-6 rounded-2xl bg-white px-4 py-4 text-sm text-stone-500">{dict.globalContent.imageEmpty}</p>
            )}
          </section>
        </div>
