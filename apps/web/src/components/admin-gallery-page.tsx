      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-8 rounded-[32px] border border-stone-300/80 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4 rounded-[1.5rem] border border-stone-200 bg-white p-4">
                ...
                {resizeMode === "resize" ? (
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <label className="block">
                      <span className="text-sm font-medium text-stone-700">{dict.gallery.height}</span>
                      <input
                        className="mt-2 w-full rounded-2xl border border-stone-300 px-4 py-3 outline-none transition focus:border-emerald-600"
                        inputMode="numeric"
                        onChange={(event) => {
          ...
          {images && images.length === 0 ? (
            <p className="mt-6 rounded-2xl bg-stone-50 px-4 py-4 text-sm text-stone-500">{dict.gallery.empty}</p>
          ) : null}
