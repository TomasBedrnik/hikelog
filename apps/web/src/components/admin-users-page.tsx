      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-8 rounded-[32px] border border-stone-300/80 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-stone-600">
            Authorized Google accounts that can access administration pages.
          </p>

          {error && <p className="mt-4 rounded-xl bg-red-50 px-4 py-3 text-sm text-red-700">{error}</p>}
          {!admins && !error && <p className="mt-4 text-sm text-stone-600">Loading…</p>}
